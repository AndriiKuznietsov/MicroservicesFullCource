...
public class CommandsController : ControllerBase
{
    ...
    {
        Console.WriteLine($"--> Getting Commands from Command Service. PlatformID: {platformId}");
    ...
    {
        Console.WriteLine($"--> Getting Command for PlatformID: {platformId} CommandID: {commandId}");
